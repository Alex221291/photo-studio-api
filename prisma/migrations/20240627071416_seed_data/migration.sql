...
VALUES 
('327df335-b73f-4bcb-970a-cc26ece8f32b', '1 час', 0, 'Большая циклорама@#$Дизайнерская мебель@#$Разнообразные аксессуары@#$омфортабельная гримерка@#$', 4500),
('06084dca-7c0d-4af2-b2dd-d8a10e96a20d', '> 2 часов', 14, 'Большая циклорама@#$Дизайнерская мебель@#$Разнообразные аксессуары@#$омфортабельная гримерка@#$', 1200),
('d7b83558-5add-49ba-b6d8-1310ad27788a', '3-4 часа', 28, 'Большая циклорама@#$Дизайнерская мебель@#$Разнообразные аксессуары@#$омфортабельная гримерка@#$', 1000),
('62a3ca95-e306-4648-9fcd-7a1c8de8d50c', '> 5 часов', 35, 'Большая циклорама@#$Дизайнерская мебель@#$Разнообразные аксессуары@#$омфортабельная гримерка@#$', 900);
...
INSERT INTO "Filming" (id, title, description, "order", price, "pictureId")
VALUES
('d398b7cf-6007-47f1-a3de-acfa9b2ebafd', 'Аренда фотостудии',  'Хит', 0, '', '382a4a5c-8555-4329-ab6e-3212d9aafdc0'),
('4bd77d27-c9eb-4178-bba4-4773fb48a4aa', 'Фотограф Дарья',  '8 лет опыта', 1, '4 500 ₽ / час      Выездная +1000 ₽', 'e463a386-5475-48ae-800a-4d59b49a5e4e'),
('821d31bd-53e3-4bd7-92af-f2c6b72177fa', 'Фотограф Александр',  '14 лет опыта', 2, '', '4916e275-059e-44d9-9c08-59d371fca9d6'),
('cbda57c3-013f-4c50-b576-782f0a3df626', 'Абонимент на фотосъемку',  '', 3, '', 'af60e668-47c1-41fb-9893-0df48cb625bd');
